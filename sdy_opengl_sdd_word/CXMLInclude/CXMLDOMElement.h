...
//#import "C:\\Windows\\SysWow64\\msxml4.dll" no_namespace
// CXMLDOMElement 包装类

class CXMLDOMElement : public COleDispatchDriver
{
public:
  CXMLDOMElement(){} // 调用 COleDispatchDriver 默认构造函数
  CXMLDOMElement(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
  CXMLDOMElement(const CXMLDOMElement& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
  ...
  VARIANT getAttribute(LPCTSTR name)
  {
    VARIANT result;
    static BYTE parms[] = VTS_BSTR ;
    InvokeHelper(0x63, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, name);
    return result;
  }
  void setAttribute(LPCTSTR name, VARIANT& value)
  {
    static BYTE parms[] = VTS_BSTR VTS_VARIANT ;
    InvokeHelper(0x64, DISPATCH_METHOD, VT_EMPTY, NULL, parms, name, &value);
  }
  void removeAttribute(LPCTSTR name)
  {
    static BYTE parms[] = VTS_BSTR ;
    InvokeHelper(0x65, DISPATCH_METHOD, VT_EMPTY, NULL, parms, name);
  }
  ...
  LPDISPATCH setAttributeNode(LPDISPATCH DOMAttribute)
  {
    LPDISPATCH result;
    static BYTE parms[] = VTS_DISPATCH ;
    InvokeHelper(0x67, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, DOMAttribute);
    return result;
  }
  LPDISPATCH removeAttributeNode(LPDISPATCH DOMAttribute)
  {
    LPDISPATCH result;
    static BYTE parms[] = VTS_DISPATCH ;
    InvokeHelper(0x68, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, DOMAttribute);
    return result;
  }
  LPDISPATCH getElementsByTagName(LPCTSTR tagName)
  {
    LPDISPATCH result;
    static BYTE parms[] = VTS_BSTR ;
    InvokeHelper(0x69, DISPATCH_METHOD, VT_DISPATCH, (void*)&result, parms, tagName);
    return result;
  }
  void normalize()
  {
