...
// CXMLDOMAttribute 包装类

class CXMLDOMAttribute : public COleDispatchDriver
{
public:
  CXMLDOMAttribute(){} // 调用 COleDispatchDriver 默认构造函数
  CXMLDOMAttribute(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
  CXMLDOMAttribute(const CXMLDOMAttribute& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
