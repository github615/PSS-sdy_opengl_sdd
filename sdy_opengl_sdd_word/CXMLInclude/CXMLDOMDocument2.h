...
// CXMLDOMDocument2 包装类

class CXMLDOMDocument2 : public COleDispatchDriver
{
public:
  CXMLDOMDocument2(){} // 调用 COleDispatchDriver 默认构造函数
  CXMLDOMDocument2(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
  CXMLDOMDocument2(const CXMLDOMDocument2& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
public:
  ...
  void putref_schemas(VARIANT& newValue)
  {
    static BYTE parms[] = VTS_VARIANT ;
    InvokeHelper(0xca, DISPATCH_PROPERTYPUTREF, VT_EMPTY, NULL, parms, &newValue);
  }
  LPDISPATCH validate()
  {
    LPDISPATCH result;
  ...
  void setProperty(LPCTSTR name, VARIANT& value)
  {
    static BYTE parms[] = VTS_BSTR VTS_VARIANT ;
    InvokeHelper(0xcc, DISPATCH_METHOD, VT_EMPTY, NULL, parms, name, &value);
  }
  VARIANT getProperty(LPCTSTR name)
  {
    VARIANT result;
    static BYTE parms[] = VTS_BSTR ;
    InvokeHelper(0xcd, DISPATCH_METHOD, VT_VARIANT, (void*)&result, parms, name);
    return result;
  }
