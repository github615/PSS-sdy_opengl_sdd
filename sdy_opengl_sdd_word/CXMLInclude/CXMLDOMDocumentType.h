...
// CXMLDOMDocumentType 包装类

class CXMLDOMDocumentType : public COleDispatchDriver
{
public:
  CXMLDOMDocumentType(){} // 调用 COleDispatchDriver 默认构造函数
  CXMLDOMDocumentType(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
  CXMLDOMDocumentType(const CXMLDOMDocumentType& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
