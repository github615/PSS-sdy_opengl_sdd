...
// CXMLDOMDocumentFragment 包装类

class CXMLDOMDocumentFragment : public COleDispatchDriver
{
public:
  CXMLDOMDocumentFragment(){} // 调用 COleDispatchDriver 默认构造函数
  CXMLDOMDocumentFragment(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
  CXMLDOMDocumentFragment(const CXMLDOMDocumentFragment& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
